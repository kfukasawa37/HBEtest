##########R functions for state-space harvest-based estimation
...
fit.hbm<-function(C,E,initpar=c(0.1,-5),Smax=10000,...){
...
####function to obtain probability distribution of population size
#[argument]
	#hbmfit:output from fit.hbm()
#[value]
	#list of length 2
		#$muN: vector of mean population size, Nt
		#$smooth: probability distribution of population size, list of length 2
			#$N0: distribution of initial population size, N0
			#$St: distribution of population size after reproduction, St
